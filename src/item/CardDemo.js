    ...
    <div className="bg-white rounded-[0.8rem] cursor-pointer relative">
      ...
      <div className="px-[12px] pt-[12px] pb-[24px] flex items-center">
        <div className="w-2/4 pt-[12px] pl-[12px] pl-[20px]">
          <div className="text-[18px] text-[#303545]">Hello</div>
        ...
        <div className="w-2/4 pt-[12px] pl-[12px] pl-[20px] pr-[20px] flex">
          <div className="w-[90%]">
            <div className="text-[18px] text-[#303545]">Xin chào</div>
            <div className="shadow-word h-[0.25rem]"></div>
            <div className="mt-2 text-[#939bb4] text-[0.75rem] font-semibold tracking-[0.0625rem]">
              DEFINITION
            </div>
          ...
          <input type="file" id="card" className="hidden" />

          <label htmlFor="card" className="cursor-pointer hidden">
            <img
              src="https://images.unsplash.com/photo-1657299141984-dd9196274cde?ixlib=rb-1.2.1&ixid=MnwxMjA3fDF8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1374&q=80"
              alt="img"
