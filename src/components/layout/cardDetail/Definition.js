...
const Definition = () => {
  return (
    <div className="bg-white p-[40px] w-full rounded-xl flex">
      <div className="w-[30%]">
        <h1 className="text-[30px] font-bold text-red-400">Function</h1>
      ...
      <div className="w-[65%] pr-[18px] border-r-[1px] ">
        ...
        <div className="mt-[20px] font-normal text-[#939bb4]">DEFINITION</div>
        <div className="text-[14px] text-[#303545]">Dinh nghia</div>
        <div className="mt-[10px] font-normal text-[#939bb4]">DEFINITION</div>
        <div className="text-[14px] text-[#303545]">Dinh nghia</div>
      </div>
